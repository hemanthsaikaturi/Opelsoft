...
const INFO = [
  { tint: '#4F46E5', label: 'Office', value: '394 Edgware Road, London W2 1ED, United Kingdom', icon: <><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></> },
  { tint: '#7C3AED', label: 'Email', value: 'info@opelsoft.com', icon: <><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-10 7L2 7" /></> },
  { tint: '#0EA5E9', label: 'Phone', value: '+44 20 7946 0958', icon: <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.61 1h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.57a16 16 0 0 0 5.86 5.86l.91-.91a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z" /> },
  { tint: '#10B981', label: 'Hours', value: 'Mon – Fri, 9am – 6pm GMT', icon: <><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></> },
];
