...
const SOLUTIONS = [
  { tint: '#4F46E5', name: 'IT & Software Staffing', body: 'Engineers and specialists across machine learning, Java, Python, full-stack, cloud, and DevOps — ready to ship.', icon: <><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></> },
  { tint: '#7C3AED', name: 'Executive Search', body: 'Confidential senior-leadership and C-suite placement, matched to your culture and growth stage.', icon: <><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="3" /><line x1="12" y1="2" x2="12" y2="5" /><line x1="12" y1="19" x2="12" y2="22" /></> },
  { tint: '#0EA5E9', name: 'Engineering Staffing', body: 'Hardware, embedded, manufacturing, aerospace, and energy specialists for complex technical programs.', icon: <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" /> },
  { tint: '#10B981', name: 'Professional Services', body: 'Finance, accounting, HR, legal, and operations professionals to scale your back office.', icon: <><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></> },
  { tint: '#F59E0B', name: 'Healthcare Staffing', body: 'Clinical and non-clinical roles, sourced and screened for compliance and fit.', icon: <path d="M22 12h-4l-3 9L9 3l-3 9H2" /> },
  { tint: '#EF4444', name: 'Creative & Marketing', body: 'Product designers, copywriters, brand, and growth-marketing talent for modern teams.', icon: <><circle cx="13.5" cy="6.5" r=".5" /><circle cx="17.5" cy="10.5" r=".5" /><circle cx="8.5" cy="7.5" r=".5" /><circle cx="6.5" cy="12.5" r=".5" /><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z" /></> },
];

const MODELS = [
  { tint: '#4F46E5', name: 'Contract / Temporary', body: 'Flexible capacity for projects, peaks, and specialised skills — scale up or down on demand.', icon: <><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></> },
  { tint: '#7C3AED', name: 'Direct Hire', body: 'Permanent placements where we source, screen, and shortlist so you only meet the best.', icon: <><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><polyline points="17 11 19 13 23 9" /></> },
  { tint: '#0EA5E9', name: 'Contract-to-Hire', body: 'Try-before-you-hire engagements that de-risk permanent decisions.', icon: <><polyline points="17 1 21 5 17 9" /><path d="M3 11V9a4 4 0 0 1 4-4h14" /><polyline points="7 23 3 19 7 15" /><path d="M21 13v2a4 4 0 0 1-4 4H3" /></> },
  { tint: '#10B981', name: 'Managed Capacity', body: 'A dedicated, outcome-based team that owns a function or workstream end to end.', icon: <><polygon points="12 2 2 7 12 12 22 7 12 2" /><polyline points="2 17 12 22 22 17" /><polyline points="2 12 12 17 22 12" /></> },
];
...
const VALUES = [
  ...
  { tint: '#7C3AED', title: 'An end-to-end recruiting process', body: 'We own every step for you — from defining the goal and screening candidates, through interviews and skills validation, to offers, onboarding, and performance management. You stay focused on running and growing your business while we handle the hiring.', icon: <><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></> },
  { tint: '#10B981', title: 'Compliance you can rely on', body: 'Our compliance team handles precise contractual screening — background, financial, and substance checks — and makes sure every document is signed, every detail is handled correctly, and your data is protected to the highest security standards, for contractors and clients alike.', icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /> },
];
